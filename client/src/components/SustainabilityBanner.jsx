  ...
  return (
    <MotionSection as="section" className="overflow-hidden font-sans border-b border-slate-100" id="sustainability-banner">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[460px]">
        ...
        <div className="bg-gradient-to-br from-[#0f3a5e] via-[#0f3a5e] to-[#071d33] flex flex-col justify-center items-start text-left p-8 sm:p-12 md:p-16 lg:p-20 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-xl">
            ...
            <h2 className="text-h2 md:text-h2-lg font-bold tracking-tight mb-6 leading-tight font-outfit">
              Investing in Efficient Delivery and Local Skills
            </h2>
            <p className="text-body md:text-body-lg text-slate-300 leading-relaxed mb-8 font-medium">
            ...
            <Link 
              to="/sustainability" 
              className="text-nav inline-flex items-center gap-3 bg-[#005f9e] hover:bg-[#005f9e] text-white border border-[#60a5fa]/40 hover:border-white transition-all duration-300 px-8 py-4 font-black tracking-wide font-outfit shadow-2xl active:scale-95 group"
            >
