...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full transition-all duration-300 font-sans">
      {/* Top Information Bar */}
      <div 
        className={`bg-white text-gray-800 transition-all duration-300 overflow-hidden ${
          isScrolled ? 'h-0 opacity-0' : 'h-auto py-3 border-b border-gray-100'
        }`}
      >
      ...
      <div 
        className={`w-full transition-all duration-300 ${
          isScrolled 
            ...
            : 'bg-[#eef6fc]/90 backdrop-blur-md border-b border-[#d8e9f6]'
        }`}
      >
        <div className="max-w-[90rem] mx-auto px-6 sm:px-8 md:pr-0 lg:pl-12 lg:pr-0 flex justify-between items-stretch">
