...
const OperationalCoverage = () => {
  return (
    <MotionSection as="section" className="py-20 bg-white overflow-hidden font-sans" id="coverage">
      <div className="max-w-[1150px] mx-auto px-6 md:px-10 lg:px-12">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-12 items-center">

          <div className="w-full lg:w-5/12 flex flex-col gap-8 order-1 text-left">
              ...
              <div className="divide-y divide-slate-100">
                <div className="flex items-center gap-4 p-5">
                  ...
                  <div className="min-w-0">
                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-0.5">Active Teams</p>
                    <p className="text-2xl md:text-3xl font-black text-brand-dark tracking-tight">120+</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-5">
                  ...
                  <div className="min-w-0">
                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-0.5">Avg Response Time</p>
                    <p className="text-2xl font-black text-brand-dark tracking-tight">&lt; 4Hrs</p>
                  </div>
                </div>
