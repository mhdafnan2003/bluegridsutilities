...
const Footer = () => {
  return (
    <footer className="bg-[#0b1120] text-gray-400 py-20 text-sm font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <h3 className="text-white font-bold text-lg mb-6">Legal Links</h3>
            <ul className="space-y-4 text-gray-400">
              <li><Link to="/#" className="hover:text-white transition-colors">Privacy Notice</Link></li>
              <li><Link to="/#" className="hover:text-white transition-colors">Terms of Use</Link></li>
              <li><Link to="/#" className="hover:text-white transition-colors">Cookies Policy</Link></li>
          ...
          <div>
            <h3 className="text-white font-bold text-lg mb-6">Company Info</h3>
            <ul className="space-y-4 text-gray-400 leading-relaxed">
              ...
              <li>
                Company Number: <span className="text-white">16442340</span>
              </li>
            </ul>
          </div>

          {/* Column 4: About & Security */}
          <div>
            <img src={logo} alt="Bluegrid Utilities Logo" className="h-10 w-auto object-contain brightness-0 invert opacity-90 block mb-6" />
            <p className="text-gray-400 leading-relaxed mb-4 text-xs">
              All information submitted through this website is handled securely and used only for recruitment, onboarding, project communication, and business enquiry purposes.
            </p>
            <p className="text-brand-primary/90 text-xs font-medium">
              This website uses secure encrypted data transmission where applicable to protect user-submitted information.
            </p>
          </div>
        ...
        <div className="flex flex-col items-center justify-center pt-8 border-t border-white/10 gap-6">
          <p className="text-gray-500 text-center">
            © 2026 Bluegrid Utilities. All rights reserved.
          </p>
          
          <div className="flex gap-4">
              <a href="https://www.facebook.com/share/1C8CFBLgxy/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="text-brand-primary hover:text-white transition-colors" aria-label="Facebook">
             ...
             {/* <a href="#" className="text-brand-primary hover:text-white transition-colors">
              ...
              <a href="https://www.linkedin.com/company/bluegrid-utilities/" target="_blank" rel="noopener noreferrer" className="text-brand-primary hover:text-white transition-colors" aria-label="LinkedIn">
