      ...
      return (
        <div className="min-h-screen bg-slate-900 text-white flex items-center justify-center p-6">
          <div className="max-w-md w-full bg-slate-800/80 backdrop-blur border border-slate-700 rounded-2xl p-8 text-center shadow-2xl">
            ...
            <h2 className="text-h2 md:text-h2-lg font-bold text-white mb-2">Something went wrong</h2>
            <p className="text-body md:text-body-lg text-slate-400 mb-6 leading-relaxed">
            ...
            <button
              ...
              className="w-full bg-[#005f9e] hover:bg-[#004bb5] text-white font-semibold py-3 px-6 rounded-xl transition duration-200 shadow-lg shadow-blue-500/20"
            >
              Reload Page
            </button>
          </div>
